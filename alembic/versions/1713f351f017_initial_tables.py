...
Revision ID: 1713f351f017
Revises: 
Create Date: 2024-11-17 08:54:47.853447
...
def upgrade() -> None:
    ...
    sa.Column('cost_per_level', sa.Integer(), nullable=False),
    ...
    sa.Column('mined', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
